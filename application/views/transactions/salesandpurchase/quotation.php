                            ...
                            <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select_group product" data-placeholder="Choose Customer" id="customer" name="customer" style="width:100%;" required>
                                                ...
                                                <?php foreach ($customer_data as $k => $v): ?>
                                                    <option value="<?php echo $v['id'] ?>" placeholder="Choose customer"><?php echo $v['name'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <table class="table" id="product_info_table">
                                        ...
                                        <tr id="row_1">
                                            <td>
                                                <select class="select_group product" data-placeholder="Choose Item" data-row-id="row_1"
                                                        id="product_1" name="product[]" style="width:100%;" onchange="getProductData(1)" required>
                                                    <option value=""></option>
