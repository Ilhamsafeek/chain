        ...
        <div class="box">
            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <?php if (in_array('createCustomer', $user_permission)) : ?>
                        <div class="ibox-tools">
                            <a href="<?php echo base_url('sales/history') ?>" class="btn btn-primary btn-xs"><i class="fa fa-unsorted"></i> Sales Return History</a>
                        </div>
                ...
                <div class="ibox-title">
                    ...
                    <form role="form" action="<?php echo base_url('sales/createsalesreturn') ?>" method="post" id="createForm">
