        ...
        <div class="box">
            ...
            <div class="ibox ">
                ...
                <div class="ibox-title">
                    ...
                    <form role="form" action="<?php echo base_url('sales/createexpense') ?>" method="post" id="createForm">
                            ...
                            <div class="row">
                                <div class="col-sm-3" id="data_1">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input id="datepicker" name="payment_date" type="text" class="form-control" value="<?php echo date("d/m/Y"); ?>">
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="select_group product" data-placeholder="Choose Customer" data-placeholder="Choose Item" id="customer" name="customer" style="width:100%;" required>
                                            <option value=""></option>
