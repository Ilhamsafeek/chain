...
class Salesorder extends Admin_Controller
{
    ...
    */
    public function index()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($order_id) {
                ...
                redirect('salesorder/' . $order_id, 'refresh');
            } else {
    ...
    public function history()
    {
        ...
        $task_data = $this->model_salesorder->getSalesOrderData();
        $result = array();
        foreach ($task_data as $k => $v) {

            $result[$k]['sales_order_info'] = $v;

        }

        $this->data['sales_order_data'] = $result;
        $this->data['customer_data'] = $this->model_customers->getCustomerData();
        $this->data['products'] = $this->model_finalstock->getProductData();
        ...
        $this->render_template('transactions/orders/salesorderhistory', $this->data);
